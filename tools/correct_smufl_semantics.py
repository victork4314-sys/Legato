...
for g in data['glyphs']:
    ...
    # Non-notation font controls and text assembly pieces never make sound by themselves.
    ...
    # Holds and pauses outrank accidental words such as “comma”.
    ...
    # Grace notes are single grace gestures, never generic trills.
    ...
    # Clefs alter pitch only when the glyph itself carries octave displacement.
    if 'clef' in low:
    ...
    # Analytical accidental reinterpretation signs have no fixed pitch; pitch-bearing accidentals retain cents.
    ...
    # Notehead shape alone usually does not change sound. Explicit techniques do.
    ...
    # Real ornaments, tremolos, articulations and pitch gestures.
    ...
    # Instrument techniques are position-aware and explicitly audible.
    ...
    # Percussion, handbells, dance/vocal clicks, and sounding pictograms.
    ...
    # Electronic mute/unmute and level gestures affect global playback.
    ...
    # Pedal, octave and tempo families.
    if 'pedal' in low:
    ...
    # Actual ties/slurs only; control and text forms were excluded above.
